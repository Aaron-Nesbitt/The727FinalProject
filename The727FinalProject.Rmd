...
```{r}
ggplot(sentimentsAll, aes(x=WordCount, y=SentimentQDAP)) + geom_point(alpha=.1) + geom_smooth()
```

```{r}
ggplot(sentimentsAll_apple, aes(x=WordCount, y=SentimentQDAP)) + geom_point(alpha=.1) + geom_smooth()
```

```{r}
ggplot(sentimentsAll_covid, aes(x=WordCount, y=SentimentQDAP)) + geom_point(alpha=.1) + geom_smooth()
```
